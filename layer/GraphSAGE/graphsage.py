...
class GraphSAGE():
    ...
    def _build(self):
        ...
        with tf.name_scope('sample_and_agg_for_v'):
            ...
            self.v_embedding, _ = self.aggregate(self.sample_v_idx, agg_list=self.agg_list)
        with tf.name_scope('sample_and_agg_for_negatives'):
            ...
            self.neg_embedding, _ = self.aggregate(self.sample_neg_idx, agg_list=self.agg_list) # [num_neg, weight_dim_list[-1]]
